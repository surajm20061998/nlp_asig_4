...
def decode_queries(tokenizer, generated_ids):
    return [normalize_sql(query) for query in tokenizer.batch_decode(generated_ids, skip_special_tokens=True)]
...
def eval_epoch(args, model, dev_loader, gt_sql_pth, model_sql_path, gt_record_path, model_record_path):
    ...
    for encoder_input, encoder_mask, decoder_input, decoder_targets, initial_decoder_inputs in tqdm(dev_loader):
        ...
        generated_queries.extend(decode_queries(tokenizer, generated_ids))
